            ...
            if ($query->have_posts()) {
                ...
                <div class="filter-sort-row container mx-auto mb-[45px] grid grid-cols-1 md:grid-cols-4 mb-4 gap-4">
                    ...
                    <?php get_template_part("template-parts/form/select/custom", null, array(
                        ...
                        "id"            => "type-filter",
                        "active"        => $taxonomy == "resource-type" ? $term_id : null
                    )); ?>
                    ...
                    <?php get_template_part("template-parts/form/select/custom", null, array(
                        ...
                        "taxonomy"      => "industry",
                        "id"            => "industry-filter",
                        "active"        => $taxonomy == "industry" ? $term_id : null
                    )); ?>
                    ...
                    <?php get_template_part("template-parts/form/select/custom", null, array(
                        ...
                        "taxonomy"      => "topic",
                        "id"            => "topic-filter",
                        "active"        => $taxonomy == "topic" ? $term_id : null
                    )); ?>
                </div>
                <?php
                ...
                while ($query->have_posts()) {
                    ...
                    $resource_type = $resource_types ? array_pop($resource_types)->name : null;
