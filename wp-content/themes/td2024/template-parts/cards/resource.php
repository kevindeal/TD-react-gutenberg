...
if (has_post_thumbnail()) {
    ...
    echo '<a class="relative w-full mb-[30px] rounded-[20px]" href="' . trailingslashit(get_permalink()) . '" style="background-image: url(' . $thumbnail_url . '); display: block; background-size: cover; background-position: center; padding-bottom: 100%;"></a>';
}
