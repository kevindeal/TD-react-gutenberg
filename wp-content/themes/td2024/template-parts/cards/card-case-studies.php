...
echo '<div class="relative inline-table mb-[45px]">';
    ...
    if (has_post_thumbnail()) {
        ...
        echo '<a class="relative w-full mb-[30px] rounded-[20px] h-[175px]" href="' . $url . '" target="' . $target . '" style="background-image: url(' . $thumbnail_url . '); display: block; background-size: cover; background-position: center;">
