...
$press_releases_archive = get_field("press_releases_index","option");

$backgroundStyle = get_field("background_style");//get_field_object('background_style')['value'];
...
<div class="post-container container mx-auto !pt-[200px] grid grid-cols-12 gap-6">
    ...
    <div class="entry-content col-span-12 lg:col-span-9" itemprop="mainEntityOfPage">
        ...
        <?php if($press_releases_archive): ?>
        <a class="btn-secondary left medium" href="<?php print get_permalink($press_releases_archive) ?>">Press Releases</a>
        <?php endif ?>

        <div class="post-wrapper py-[80px]">
            <span class="eyebrow text-secondaryBlue-100 text-xl font-semibold block mb-[15px]">Press Release</span>
