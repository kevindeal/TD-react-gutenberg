...
<div class="page-wrapper">
    ...
    <div id="integrations-section" class="container mx-auto grid grid-cols-12 !pt-[60px] gap-6">
        ...
        <div class="widget widget_intcus_aapf_single widget-container sidebar-widgets">
            ...
            <div class="intcus_aapf_widget-wrapper brw-product_cat">
                ...
                <ul class="integration_cat leading-[40px] hidden lg:block">
                    ...
                    <?php $active = ''; if($term_current->slug == 'all-categories'){ $active = 'checked'; } ?>

                    <a href="<?php echo get_site_url(); ?>/data-integrations/#integrations-section" class="integrationcat cursor-pointer" data-ol-has-click-handler="">
                        <li class="intcus_term_parent_0 intcus_term_depth_0">
                        <span>
                            <label class="intcus_label_widgets cursor-pointer">All Categories</label>
                        </span>                              
                        </li>
                    </a>
                    ...
                    if($cat->slug != 'all-categories' && $cat->slug != 'private-beta'){
                        $term = get_term( $cat->term_id, 'product_cat' );
                        $term_link = get_term_link( $term );
                        $activeClass = ''; if($term_current->slug == $cat->slug){ $activeClass = 'checked'; }
                    ?>
                        <a href="<?php echo $term_link; ?>/#integrations-section" class="integrationcat">
                            <li class="intcus_term_parent_0 intcus_term_depth_0 <?php echo $activeClass; ?>">
                                <span>
        ...
        <script>$(window).on('load',function(){elsToMatch = [$('.icon-box-content > p')];minWinWidth = [960];matchHeights(elsToMatch, minWinWidth);});</script>
        </div>
