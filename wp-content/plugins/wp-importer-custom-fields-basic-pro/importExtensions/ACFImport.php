...
class ACFImport {
    ...
    function acf_import_function($acf_wpname_element ,$acf_csv_element, $importAs , $post_id,$mode,$post_values,$line_number,$hash_key,$gmode,$templatekey,$poly_values=null){
        ...
        foreach($get_acf_fields as $keys => $value_type){
                ...
                elseif ($field_type == 'gallery') {
                                        ...
                                        if($ext){
                                                if(strstr($ext,'jpg') || $ext == 'jpeg' || $ext == 'png' || $ext == 'gif') {
                                                        ...
                                                        if(!empty($img_id)) {
                                                                ...
                                                                ACFImport::$media_instance->acfgalleryMetaImports($gallery_ids,$imgmeta,$plugin);
                                                        }else{
                                                                $get_gallery_id = ACFImport::$media_instance->image_meta_table_entry($imgmeta, $post_id, $acf_wpname_element, $gallery, $hash_key, 'acf_gallery', $get_import_type,$templatekey,$gmode);	
                                                                if($get_gallery_id != '') {
                        ...
                        // $acf_pro_instance->acf_imagemeta_update($gallery_ids, $imgmeta, $plugin, $option_entry, 'gallery');
